...
Functions to compute survival and transition probabilities using variable stage durations. p. 162 on Caswell's book. NOT DONE YET AS OF 12/19/2019. FINISH THIS. 
```{r}
...
The fecundity for the maturing adult stage is computed as the following: Eggs/nest (103.9) x nests/female (6.2) x prop breed (0.12) x sex ratio (see below). This is also an unknown as the maturing adult survival rate is unknown.  

Proportion of breeding females is included.

Modelrate climate: 103.9 x 6.2 x 0.12 x 0.88 = 68.0

Extreme climate: 103.9 x 6.2 x 0.12 x 0.99 = 76.5
...
in.list <- list(Ts = c(5, 9, 10, 6),   # average years in two juvenile stages and subadults
                VT =  c(1, (1.9^2), (1.9^2), 1), # variance of years in juvenile stages 
                f =  c(68, 106.0 * 0.95), # prop breed and adult survival included 
                phi.1 =  0.4,
                phi.A = 0.95,
                lambda = 1.04)
...
First year breeder fertility: (eggs/nest) x (nests/female) x (prop.breed.) x sex ratio

Moderate climate: 103.9 x 6.2 x 0.12 x 0.88 = 68.0
